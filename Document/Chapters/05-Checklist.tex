...
\begin{description}%
\item[]%
\textit{Acrocephalus dumetorum (LC\footref{NO-LCS})}%
\item[]%
...
\item[D: ]%
Primarily feeds on insects like grasshoppers, caterpillars, dragonflies, and mantises. It also eats spiders, smaller insects, fruit, and nectar.%
\item[R: ]%
...
\end{description}%
\end{enumerate}%
\vspace*{\fill} % Fill the space above the content to push it to the bottom
\begin{figure}[!htpb]
    \centering
...
\begin{description}%
\item[]%
\textit{Prinia inornata (LC)}%
\item[]%
\textbf{Plain Prinia}%
\end{description}%
\begin{description}%
\item[H: ]%
Common breeding resident throughout the Island.Prefers paddyfields, scurb, marshes and reeds as habitat{[}2{]}.%
\item[D: ]%
Diet consists almost entirely of small invertebrates, primarily ants, beetles, caterpillars, grasshoppers, spiders, and flies%
\item[R: ]%
Boat Yard and Open area behing the Boat Yard.%
\end{description}%
\end{enumerate}%
\item%
Columbidae%
...
\begin{description}%
\item[]%
\textit{Cacomantis passerinus (LC\footref{NO-LCS})}%
\item[]%
...
\begin{description}%
\item[]%
\textit{Clamator jacobinus (LC)}%
\item[]%
\textbf{Pied Cuckoo/Jacobin Cuckoo}%
\end{description}%
\begin{description}%
\item[H: ]%
Uncommon breeding resident from lowlands to mid hills. A winter migrant population also exist{[}2{]}.%
\item[D: ]%
 Feeds on various insects, especially favoring hairy caterpillars. Also known for consuming fruits%
\item[R: ]%
Single sighting at Boat Yard.%
\end{description}%
\item%
\begin{description}%
\item[]%
\textit{Hierococcyx varius (VU)}%
\item[]%
\textbf{Common Hawk-Cuckoo}%
\end{description}%
\begin{description}%
\item[H: ]%
Uncommon breeding resident with a rare migrant population. Has become more regular on lowlands in the recent past. Highly arboreal{[}2{]}.%
\item[D: ]%
Insectivores with special preference for catepillars.%
\item[R: ]%
Near L Canteen,around Sumanadasa building, and inside Kaju Kele.%
\end{description}%
\end{enumerate}%
\item%
Dicaeidae%
...
\begin{description}%
\item[]%
\textit{Hirundo rustica (LC\footref{NO-LCS})}%
\item[]%
\textbf{Barn Swallow}%
\end{description}%
\begin{description}%
...
\item[D: ]%
Primarily feeds on insects found on the water surface and invertebrates gleaned from the roots and leaves of aquatic vegetation.%
\item[R: ]%
Boat yard and the surrounding areas of Bolgoda lake.
\end{description}%
\end{enumerate}%
...
\begin{description}%
\item[]%
\textit{Lanius cristatus (LC\footref{NO-LCS})}%
\item[]%
\textbf{Brown Shrike}%
\end{description}%
\begin{description}%
...
\begin{description}%
\item[]%
\textit{Chlidonias hybrida (LC\footref{NO-LCS})}%
\item[]%
...
\begin{description}%
\item[]%
\textit{Motacilla tschutschensis/flava\footnote{The presence of Eastern Yellow Wagtail in Sri Lanka is still a matter of debate. Hence it could be either of the two species. } (LC\footref{NO-LCS})}%
\item[]%
...
\begin{description}%
\item[]%
\textit{Dendronanthus indicus (LC\footref{NO-LCS})}%
\item[]%
...
\begin{description}%
\item[]%
\textit{Muscicapa muttui (LC\footref{NO-LCS})}%
\item[]%
...
\begin{description}%
\item[]%
\textit{Muscicapa dauurica (LC\footref{NO-LCS})}%
\item[]%
...
\begin{description}%
\item[]%
\textit{Oriolus kundoo (LC\footnote{\label{NO-LCS}National Conservation Status not available/applicable. This is Global Conservation Status according to the the National Red List 2021.})}%
\item[]%
...
\begin{description}%
\item[]%
\textit{Picus chlorolophus (NT)}%
\item[]%
\textbf{Lesser Yellownape}%
\end{description}%
\begin{description}%
\item[H: ]%
Uncommon breeding resident. Distributed from wet lowlands to adjacent drier areas. Forests and wooded areas are the preffered habitat{[}2{]}.%
\item[D: ]%
Insectivorous woodpecker. Diet consists primarily of ants, beetles, and their larvae. Also known to consume small fruits and nectar.%
\item[R: ]%
Inside Kaju Kele and around the Department of Civil Engineering%
\end{description}%
\item%
\begin{description}%
\item[]%
...
\begin{description}%
\item[]%
\textit{Pitta brachyura (LC*)}%
\item[]%
\textbf{Indian Pitta}%
\end{description}%
\begin{description}%
\item[H: ]%
Common migrant except to the highest hills. Prefers undergrowth of forests{[}2{]}.%
\item[D: ]%
While primarily insectivorous, also consumes Invertebrates and seeds.%
\item[R: ]%
Heard around Kaju Kele. Only one visual observation and was at the marsh near the new garbage dump site at hotspot 2.%
\end{description}%
\end{enumerate}%
\item%
Psittaculidae%
...
\begin{description}%
\item[]%
\textit{Psittacula eupatria (LC)}%
\item[]%
\textbf{Alexandrine Parakeet}%
\end{description}%
\begin{description}%
\item[H: ]%
Uncommon breeding resident found in lowlands up to lower hills. Forests and wooded areas are the preffered habitat{[}2{]}.%
\item[D: ]%
Herbivorous and feeds on a variety of wild and cultivated seeds, buds, fruits, and nuts.%
\item[R: ]%
Kaju kele around the hotspot 2.%
\end{description}%
\item%
\begin{description}%
\item[]%
...
\begin{description}%
\item[]%
\textit{Curruca curruca (LC*)}%
\item[]%
\textbf{Lesser Whitethroat}%
\end{description}%
\begin{description}%
\item[H: ]%
Rare winter migrant to dry lowlands. Prefers Scrubs{[}2{]}.%
\item[D: ]%
primarily insectivorous carnivores, with a frugivorous component to their diet. They mainly feed on ants, flies, beetles, and other insects, while also consuming soft fruits.%
\item[R: ]%
Single sighting at Hotspot 2.%
\end{description}%
\end{enumerate}%
\item%
Threskiornithidae%
...
\begin{description}%
\item[]%
\textit{Dumetia atriceps (LC)}%
\item[]%
\textbf{Dark{-}Fronted Babbler}%
\end{description}%
\begin{description}%
\item[H: ]%
Uncommon breeding resident throughout Sri Lanka. Prefers dense undergrowth in forests{[}2{]}.%
\item[D: ]%
Primarily insectivorous.%
\item[R: ]%
Only a single individual. Several observations at the marshes near hotspot 2.%
\end{description}%
\end{enumerate}%
\item%
Turdidae%
...
\begin{description}%
\item[]%
\textit{Geokichla citrina (LC)}%
\item[]%
\textbf{Orange{-}headed Thrush}%
\end{description}%
\begin{description}%
\item[H: ]%
Rare winter migrant to lowlands and lower hills. Prefers Forest,scrub and well wooded gardens with undercover{[}2{]}.%
\item[D: ]%
A wide variety of invertebrates, such as earthworms, insects, spiders, snails, and leeches. It also consumes various berries, soft fruits, and fallen figs.%
\item[R: ]%
Single sighting of a pair at Kaju kele.%
\end{description}%
\end{enumerate}%
\item%
Zosteropidae%
