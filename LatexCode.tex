...
\item[R: ]%
Near L Canteen, Sumanadasa, and inside Kaju Kele.%
\end{description}%
\item%
\begin{description}%
\item[]%
...
\item[D: ]%
 Feeds on various insects, especially favoring hairy caterpillars. Also known for consuming some fruits%
\item[R: ]%
...
\item[R: ]%
Observed in and around hotspot 2 over multiple seasons. Only one individual was present. It's primary host tree was cut down with the destruction of hotspot 2.%
\end{description}%
\end{enumerate}%
\item%
Laridae%
...
\item[R: ]%
Only a single individual. Several observations at the marshes near hotspot 2. Displayed pseudo nesting behaviour. Nest got destroyed by the fire set on garbage.%
\end{description}%
\end{enumerate}%
\item%
Turdidae%
